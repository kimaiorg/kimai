...
export function DateTimePicker({ date, setDate }: { date: string | undefined; setDate: (date: string) => void }) {
              ...
              <div className="flex sm:flex-col p-2">
                {hours.reverse().map((hour) => (
                  <Button
                    key={hour}
                    size="icon"
                    variant={date && new Date(date).getHours() % 12 === hour % 12 ? "default" : "ghost"}
